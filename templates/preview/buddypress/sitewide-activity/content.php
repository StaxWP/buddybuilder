...
<div id="activity-stream" class="activity">
	<ul class="activity-list item-list bp-list">
		<li class="activity activity_update activity-item date-recorded-1593624040">
			<?php if ( $render ) : ?>
				...
				<div class="activity-comments">
					<form action="#" method="post" id="ac-form-632" class="ac-form">
						<div class="ac-reply-avatar">
							<img src="<?php echo esc_url( bpb_get_dummy_avatar_url( 'member', 50 ) ); ?>"
		...
		<li class="activity activity_comment activity-item">
			...
			<?php else : ?>
				...
				<div class="activity-comments">
					<ul>
						<li id="acomment-715" class="comment-item">
							...
							<div class="acomment-meta">
								<a href="#">Robertino</a> replied <a href="#" class="activity-time-since">
									<time class="time-since" datetime="2020-06-29 10:57:06">1 week, 2 days ago
									</time>
								</a>
							</div>
		...
		<li class="groups activity_update activity-item date-recorded-1589581413">
			<?php if ( $render ) : ?>
				<?php echo do_shortcode( $activity_item ); ?>
			<?php else : ?>
				<div class="activity-avatar item-avatar">
				...
				<div class="activity-content">
					<div class="activity-header">
						<p>
							...
							<a href="#">
								<img src="<?php echo esc_url( bpb_get_dummy_avatar_url( 'member', 28 ) ); ?>"
