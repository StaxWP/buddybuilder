...
class BuddybossSettings extends Singleton {
	...
	public function add_settings( \Buddy_Builder\Widgets\Base $widget ) {
		...
		$widget->add_control(
			self::PREFIX . 'content_background_color',
			[
		...
		$widget->add_group_control(
			...
			[
				'name'     => self::PREFIX . 'content_shadow',
		...
		$widget->add_group_control(
			...
			[
				'name'      => self::PREFIX . 'content_border',
				'selector'  => '{{WRAPPER}} .subnav-filters',
				'separator' => 'before',
			]
		);
		...
		$widget->add_control(
			self::PREFIX . 'content_border_radius',
			[
		...
		$widget->add_control(
			self::PREFIX . 'search_box_clear_icon_color',
			[
		...
		$widget->add_group_control(
			...
			[
				...
				'name'     => self::PREFIX . 'search_box_typography',
				'selector' => '{{WRAPPER}} #dir-activity-search-form #dir-activity-search',
			]
		);

		$widget->start_controls_tabs( self::PREFIX . 'search_box_state_style' );

		$widget->start_controls_tab(
			self::PREFIX . 'search_box_normal_tab',
			[
		...
		$widget->add_control(
			self::PREFIX . 'search_box_background',
			[
				'label'     => __( 'Background Color', 'stax-buddy-builder' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$widget->add_control(
			self::PREFIX . 'search_box_text_color',
			[
		...
		$widget->add_control(
			self::PREFIX . 'search_box_placeholder_color',
			[
		...
		$widget->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => self::PREFIX . 'search_box_shadow',
		...
		$widget->start_controls_tab(
			self::PREFIX . 'search_box_hover_tab',
			[
		...
		$widget->add_control(
			self::PREFIX . 'search_box_hover_background',
			[
				'label'     => __( 'Background Color', 'stax-buddy-builder' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$widget->add_control(
			self::PREFIX . 'search_box_text_hover_color',
			[
				'label'     => __( 'Text Color', 'stax-buddy-builder' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
		...
		$widget->add_control(
			self::PREFIX . 'search_box_placeholder_hover_color',
			[
				'label'     => __( 'Placeholder Color', 'stax-buddy-builder' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
		...
		$widget->add_control(
			self::PREFIX . 'search_box_hover_border_color',
			[
		...
		$widget->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => self::PREFIX . 'search_box_hover_shadow',
		...
		$widget->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => self::PREFIX . 'search_box_border',
				'selector' => '{{WRAPPER}} #dir-activity-search-form',
			]
		);

		$widget->add_control(
			self::PREFIX . 'search_box_border_radius',
			[
				'label'      => __( 'Border Radius', 'stax-buddy-builder' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
		...
		$widget->add_responsive_control(
			self::PREFIX . 'search_box_padding',
			[
				'label'      => __( 'Padding', 'stax-buddy-builder' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
		...
		$widget->start_controls_tabs( self::PREFIX . 'search_submit_button_state_style' );

		$widget->start_controls_tab(
			self::PREFIX . 'search_submit_button_normal_style',
			[
				'label' => __( 'Normal', 'stax-buddy-builder' ),
			]
		);
		...
		$widget->add_control(
			self::PREFIX . 'search_submit_button_bg_color',
			[
				'label'     => __( 'Background Color', 'stax-buddy-builder' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$widget->add_control(
			self::PREFIX . 'search_submit_button_color',
			[
				'label'     => __( 'Icon Color', 'stax-buddy-builder' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} #dir-activity-search-submit .bb-icon-search:before' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$widget->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => self::PREFIX . 'search_submit_button_shadow',
		...
		$widget->start_controls_tab(
			self::PREFIX . 'search_submit_button_hover_style',
			[
				'label' => __( 'Hover', 'stax-buddy-builder' ),
			]
		);
		...
		$widget->add_control(
			self::PREFIX . 'search_submit_button_hover_bg_color',
			[
				'label'     => __( 'Background Color', 'stax-buddy-builder' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$widget->add_control(
			self::PREFIX . 'search_submit_button_hover_color',
			[
				'label'     => __( 'Icon Color', 'stax-buddy-builder' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} #dir-activity-search-submit:hover .bb-icon-search:before' => 'color: {{VALUE}};',
				],
			]
		);

		$widget->add_control(
			self::PREFIX . 'search_submit_button_hover_border_color',
			[
				'label'     => __( 'Border Color', 'stax-buddy-builder' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
		...
		$widget->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => self::PREFIX . 'search_submit_button_hover_shadow',
		...
		$widget->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'      => self::PREFIX . 'search_submit_button_border',
				'selector'  => '{{WRAPPER}} #dir-activity-search-submit',
				'separator' => 'before',
			]
		);
		...
		$widget->add_control(
			self::PREFIX . 'search_submit_button_border_radius',
			[
				'label'      => __( 'Border Radius', 'stax-buddy-builder' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
		...
		$widget->add_responsive_control(
			self::PREFIX . 'search_submit_button_padding',
			[
				'label'      => __( 'Padding', 'stax-buddy-builder' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
