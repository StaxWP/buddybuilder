...
class BuddybossSettings extends Singleton {
	...
	public function add_settings( \Buddy_Builder\Widgets\Base $widget ) {
		$widget->start_controls_section(
			self::PREFIX . 'activity_container_section',
			[
				'label' => __( 'Activity Container', 'stax-buddy-builder' ),
		...
		$widget->add_group_control(
			...
			[
				'name'     => self::PREFIX . 'container_background',
				'label'    => __( 'Background', 'stax-buddy-builder' ),
				'types'    => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .activity > ul.activity-list',
			]
		);
		...
		$widget->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .activity > ul.activity-list' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$widget->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .activity > ul.activity-list' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$widget->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .activity > ul.activity-list' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$widget->start_controls_section(
			self::PREFIX . 'activity_item_container_section',
			[
		...
		$widget->add_control(
			self::PREFIX . 'item_container_border_radius',
			[
				'label'      => __( 'Border Radius', 'stax-buddy-builder' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
		...
		$widget->add_responsive_control(
			self::PREFIX . 'item_container_padding',
			[
				'label'      => __( 'Padding', 'stax-buddy-builder' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
		...
		$widget->add_control(
			self::PREFIX . 'item_spacing_items',
			[
		...
		$widget->add_control(
			self::PREFIX . 'load_more_btn_display_type',
			[
		...
		$widget->add_responsive_control(
			self::PREFIX . 'load_more_btn_align',
			[
				...
				'condition' => [
					self::PREFIX . 'load_more_btn_display_type' => 'inline-block',
				],
				'default'   => '',
			]
		);
		...
		$widget->add_control(
			self::PREFIX . 'load_more_btn_display_inline_block',
			[
				'label'     => __( 'Base Style', 'stax-buddy-builder' ),
				'type'      => Controls_Manager::HIDDEN,
				'default'   => '1',
		...
		$widget->add_group_control(
			...
			[
				'name'     => self::PREFIX . 'load_more_btn_typography',
		...
		$widget->start_controls_tab(
			self::PREFIX . 'load_more_btn_style_normal_tab',
			[
		...
		$widget->add_control(
			self::PREFIX . 'load_more_btn_background',
			[
				'label'     => __( 'Background', 'stax-buddy-builder' ),
		...
		$widget->add_control(
			self::PREFIX . 'load_more_btn_text_color',
			[
		...
		$widget->start_controls_tab(
			self::PREFIX . 'load_more_btn_style_hover_tab',
			[
		...
		$widget->add_control(
			self::PREFIX . 'load_more_btn_hover_background',
			[
				'label'     => __( 'Background', 'stax-buddy-builder' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$widget->add_control(
			self::PREFIX . 'load_more_btn_hover_text_color',
			[
				'label'     => __( 'Color', 'stax-buddy-builder' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$widget->add_control(
			self::PREFIX . 'load_more_btn_hover_border',
			[
		...
		$widget->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => self::PREFIX . 'load_more_btn_hover_shadow',
		...
		$widget->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'      => self::PREFIX . 'load_more_btn_border',
				'selector'  => '{{WRAPPER}} .load-more a, {{WRAPPER}} .load-newest a',
				'separator' => 'before',
			]
		);
		...
		$widget->add_control(
			self::PREFIX . 'load_more_btn_border_radius',
			[
				'label'      => __( 'Border Radius', 'stax-buddy-builder' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
