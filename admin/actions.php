...
$has_pro       = \Buddy_Builder\Admin::get_instance()->has_pro();
...
<div class="ste-container ste-mx-auto">
	<div class="ste-flex ste-flex-wrap ste--mx-2 ste--my-4">
		...
		<div class="ste-px-2 ste-py-4 ste-w-full lg:ste-w-1/4 ste-overflow-hidden ste-box-border">
			<?php if ( ! $has_pro ) : ?>
				<div class="ste-relative ste-bg-gradient-to-r ste-from-blue-500 ste-to-indigo-500 ste-p-6 lg:ste-p-10 ste-rounded ste-shadow-lg ste-mb-4">
			...
			<?php else : ?>
				<div class="ste-bg-amber-50 ste-p-6 lg:ste-p-10 ste-rounded ste-shadow-lg ste-mb-4">
			...
			<?php if ( $current_slug !== 'templates' ) : ?>
				<div class="ste-bg-white ste-mb-4 ste-p-6 lg:ste-p-10 ste-rounded ste-shadow-lg">
					<div class="sqp_box">
						<h2 class="ste-mt-0 ste-text-lg ste-flex ste-items-center">
							<span class="dashicons dashicons-admin-appearance ste-text-orange-600 ste-mr-2"></span>
			...
			<div class="ste-bg-white ste-p-6 lg:ste-p-10 ste-rounded ste-shadow-lg">
				<div class="sqp_box">
					<h2 class="ste-mt-0 ste-text-lg">
						<span class="dashicons dashicons-book ste-text-blue-600 ste-mr-2"></span>
						Knowledge Base
					</h2>
