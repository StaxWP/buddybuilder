<div class="ste-mr-4 lg:ste-m-0 stax-main <?php echo esc_attr( implode( ' ', $wrapper_class ) ); ?>">
	<div class="ste-mt-5 ste-mb-4">
		<div class="ste-container ste-mx-auto ste-bg-white ste-rounded ste-shadow-lg ste-overflow-hidden">
			<div class="ste-flex ste-flex-wrap ste-justify-center md:ste-justify-between ste-items-center ste-p-10">
				...
				<div class="ste-text-center md:ste-text-right">
					<h1 class="ste-block ste-leading-normal ste-my-0"><span class="ste-font-light">Welcome to</span> STAX</h1>
					<div class="ste-font-medium ste-text-sm md:ste-text-lg ste-text-gray-600">Build BuddyPress Pages with Elementor</div>
				</div>
			</div>
			...
			<?php do_action( BPB_HOOK_PREFIX . 'submenu' ); ?>
		</div>
	</div>
